// Generated on 2014-05-17 using generator-chromeapp 0.2.8
'use strict';
...
module.exports = function (grunt) {
    ...
    grunt.initConfig({
        ...
        mocha: {
            all: ['http://localhost:<%= connect.options.port %>/index.html']
        },
        ...
        compress: {
            dist: {
                options: {
                    archive: 'package/do chrome all-<%= config.manifest.version %>.zip'
                },
                files: [{
                    expand: true,
                    cwd: 'dist/',
